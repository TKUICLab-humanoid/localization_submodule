...
Mat Drawing::DrawField()    //E315 field
{
    ROS_INFO("DrawField");
    Mat Field(MAP_WIDTH, MAP_LENGTH, CV_8UC3, Scalar(0, 0, 0));
    Mat Field_edge;
    
    vector<Point> field_point1 = {Point(102,122),Point(402,122),Point(402,322),Point(102,322)};
    vector<Point> field_point2 = {Point(102,142),Point(174,142),Point(174,302),Point(102,302)};
    vector<Point> field_point3 = {Point(330,142),Point(402,142),Point(402,302),Point(330,302)};
    vector<Point> field_point4 = {Point(102,172),Point(140,172),Point(140,272),Point(102,272)};
    vector<Point> field_point5 = {Point(364,172),Point(402,172),Point(402,272),Point(364,272)};
    vector<Point> field_point6 = {Point(255,122),Point(255,322)};

    vector<vector<Point>> field_point = {field_point1,field_point2,field_point3,field_point4,field_point5,field_point6};

    rectangle(Field, Point(102,122), Point(402,322), Scalar(255, 255, 255), 2);
    rectangle(Field, Point(102,142), Point(174,302), Scalar(255, 255, 255), 2);
    rectangle(Field, Point(330,142), Point(402,302), Scalar(255, 255, 255), 2);
    rectangle(Field, Point(102,172), Point(140,272), Scalar(255, 255, 255), 2);
    rectangle(Field, Point(364,172), Point(402,272), Scalar(255, 255, 255), 2);

    circle(Field, Point(255,222), 73, Scalar(255, 255, 255), 2);

    line(Field, Point(255,122), Point(255,322), Scalar(255, 255, 255), 2);

    line(Field, Point(252,222), Point(258,222), Scalar(255, 255, 255), 2);
    
    line(Field, Point(137,219), Point(137,225), Scalar(255, 255, 255), 2);
    line(Field, Point(134,222), Point(140,222), Scalar(255, 255, 255), 2);

    line(Field, Point(347,219), Point(347,225), Scalar(255, 255, 255), 2);
    line(Field, Point(343,222), Point(349,222), Scalar(255, 255, 255), 2);
    ...
    cv::Canny(Field, Field_edge, 50, 150, 3);
    Field_edge=convertTo3Channels(Field_edge);
    line(Field_edge, Point(82,182), Point(102,182), Scalar(0, 255, 255), 2);
    line(Field_edge, Point(82,182), Point(82,262), Scalar(0, 255, 255), 2);
    line(Field_edge, Point(82,262), Point(102,262), Scalar(0, 255, 255), 2);
    line(Field_edge, Point(402,182), Point(422,182), Scalar(0, 255, 255), 2);
    line(Field_edge, Point(422,182), Point(422,262), Scalar(0, 255, 255), 2);
    line(Field_edge, Point(402,262), Point(422,262), Scalar(0, 255, 255), 2);
    return Field_edge;
}
